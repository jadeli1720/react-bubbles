...
- [x] Describe how web servers work.
        1.) A browser obtains a pages IP address.
        2.) Using the IP address, they make a URL request from the server
        3.) Web Server responds by sending the pages that correspond with the     request
        4.) Browser displays the page received from web server
